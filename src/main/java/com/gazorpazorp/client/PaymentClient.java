...
public interface PaymentClient {
	...
	public ResponseEntity processPayment(@RequestParam("customerId") String customerId, @RequestParam("driverId") String driverId, @RequestParam("orderId") Long orderId, @RequestParam("amount") Integer amount);
}
